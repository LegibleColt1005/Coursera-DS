...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = filtered_df[ filtered_df['Launch Site'] == entered_site].groupby('Class').size()
        fig = px.pie(filtered_df, values='class', 
            names='Class', 
            title='Success vs faild launch in' + entered_site)
...
def get_scatter_plot(entered_site, slider_range):
    ...
    if entered_site == 'ALL':
        ...
        x = 'Payload Mass (kg)', 
        y = 'class', 
        title='Correlation between Payload and Launch success ' + entered_site,
        color = "Booster Version Category")
